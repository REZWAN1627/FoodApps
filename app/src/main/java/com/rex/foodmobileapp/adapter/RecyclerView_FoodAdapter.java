package com.rex.foodmobileapp.adapter;
...
import com.rex.foodmobileapp.DetailsOfFoodProduct;
import com.rex.foodmobileapp.R;
import com.rex.foodmobileapp.model.FoodItemModel;
...
public class RecyclerView_FoodAdapter extends RecyclerView.Adapter<RecyclerView_FoodAdapter.RecyclerView_BurgerViewHolder>  {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerView_BurgerViewHolder holder, int p) {
